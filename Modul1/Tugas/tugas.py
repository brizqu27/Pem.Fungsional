def inputData(data_peserta, id, nama, nilai):
    peserta = {"id": id,"nama": nama,"nilai": nilai,}
...
def showNilaiAdmin(peserta):
    if peserta:
        ...
        return {"ID": peserta["id"],"Nama": peserta["nama"],"Nilai": peserta["nilai"],"Hasil Akhir": hasil_akhir}
    else:
...
def showNilai(peserta):
    if peserta:
        ...
        return {"ID": peserta["id"],"Nama": peserta["nama"],"Nilai": peserta["nilai"],"Hasil Akhir": hasil_akhir,"Pesan": pesan}
    else:
        return "ID yang Anda masukkan tidak ditemukan!"
